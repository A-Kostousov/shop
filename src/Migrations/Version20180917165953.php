 ...
 */
final class Version20180917165953 extends AbstractMigration
{
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE `order` (id INT AUTO_INCREMENT NOT NULL, created_at DATETIME NOT NULL, status VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, payment_status VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, account VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, amount NUMERIC(12, 2) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
        $this->addSql('CREATE TABLE order_item (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, quantity VARCHAR(255) NOT NULL COLLATE utf8mb4_unicode_ci, price NUMERIC(12, 2) NOT NULL, amount NUMERIC(12, 2) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB');
